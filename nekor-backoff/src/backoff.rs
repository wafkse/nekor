...
///
/// - [`Base2`]: Low contention, fast resolution needed (e.g., brief atomic
///   operations)
...
///
/// - The *Exponential Base*: The base value used for the exponential backoff.
///   This is not a discrete value, but a selection from predefined values. See
///   the [`ExponentialBase`] enum.
///
/// - The *Exponential Ceiling*: The maximum backoff value, i.e. the maximum
///   numeric delay that the backoff can reach. Any delay value will be clamped
///   to the `[0, c]` interval, where `c` is the *Exponential Ceiling*.
///
